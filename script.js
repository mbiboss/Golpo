...
function showInstallPrompt() {
    ...
    showNotification(
        ...
        10000,
        {
            subtitle: 'Get the full app experience with offline reading!',
            persistent: false,
            actions: [
                {
                    label: 'Install',
...
async function promptInstall(notificationId) {
    if (!deferredPrompt) {
        showNotification('Installation not available on this device', 'info', 2000);
        return;
    }
